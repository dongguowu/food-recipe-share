package com.dishdiscoverers.foodrecipe.dongguo.repository.json
...
/**
 * Converts a  [RecipeTheMeal] from the API response to a [Recipe] object.
 *
...
/**
 * Converts a [CategoryTheMeal] from the API response to a [Category] object.
 *
 * @param item The meal category to convert.
